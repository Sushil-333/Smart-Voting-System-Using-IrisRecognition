...
"font: 20pt \"Vani\";")
        ...
        self.voter.setStyleSheet("image: url(./images/userss.png);")
        self.voter.setText("")
        ...
        self.admin.setStyleSheet("image: url(./images/user-admin-gear.png);")
        self.admin.setText("")
...
"color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Voting System by Tejash"))
